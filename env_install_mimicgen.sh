...
mamba env create -f conda_environment_mimicgen.yaml -y
...
cd third_party/mimicgen/robosuite
pip install -e .
...
cd third_party/mimicgen/robosuite-task-zoo
pip install -e .
...
cd third_party/mimicgen/robomimic
pip install -e .
...
cd third_party/mimicgen/mimicgen
pip install -e .
