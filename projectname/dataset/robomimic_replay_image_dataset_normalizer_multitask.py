...
from projectname.common.pytorch_util import dict_apply
from projectname.dataset.base_dataset import BaseImageDataset, LinearNormalizer
from projectname.model.common.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
from projectname.model.common.rotation_transformer import RotationTransformer
from projectname.codecs.imagecodecs_numcodecs import register_codecs, Jpeg2k
from projectname.common.replay_buffer import ReplayBuffer
from projectname.common.sampler import SequenceSampler, get_val_mask
from projectname.common.normalize_util import (
...
class RobomimicReplayImageDataset(BaseImageDataset):
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        # action
        with open("equi_diffpo/constant/normalizer_Action_ABCDEFGH.pkl", "rb") as f:
        ...
        for key in self.lowdim_keys:
            ...
            if key.endswith('pos') and not key.endswith('qpos'):
                with open("equi_diffpo/constant/normalizer_Pos_ABCDEFGH.pkl", "rb") as f:
                    this_normalizer = pickle.load(f)
