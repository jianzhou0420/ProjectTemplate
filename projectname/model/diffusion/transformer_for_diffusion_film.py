...
from projectname.model.diffusion.jian_transformer_decoder_film import FilMSelfAttnDecoderLayer, FiLMLayer, FilMTransformerDecoder
...
class TransformerForDiffusion(ModuleAttrMixin):
    def __init__(self,
                 ...
                 enable_film_self_attn: bool = False,
                 enable_film_ffn: bool = False,
                 n_cond_layers: int = 0,
                 ) -> None:
        super().__init__()
