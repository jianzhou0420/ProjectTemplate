...
EXP_NAME="ICRA_DP_C_Stage2_Multitask_seed${SEED}"
...
DESCRIPTIVE_TASK_NAME=${TASK_MAP["$INPUT_TASK_LETTERS"]}

run_name="${EXP_NAME}__${INPUT_TASK_LETTERS}"
run_dir="data/outputs/${date_part}/${time_part}_${run_name}"

ckpt_path="data/robomimic/Stage1/ICRA_DP_C_Stage1_Multi_seed42__ACG_epoch\=009.ckpt"
